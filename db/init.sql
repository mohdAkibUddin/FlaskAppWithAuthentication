...
CREATE TABLE IF NOT EXISTS oscar_winning_actors (
...
INSERT INTO oscar_winning_actors VALUES
    ...
    (20,1947,35, 'Loretta Young', 'The Farmers Daughter'),
    ...
    (39,1966,35, 'Elizabeth Taylor', 'Whos Afraid of Virginia Woolf?'),
    (40,1967,60, 'Katharine Hepburn', 'Guess Whos Coming to Dinner'),
    ...
    (48,1975,42, 'Ellen Burstyn', 'Alice Doesnt Live Here Anymore'),
    (49,1976,41, 'Louise Fletcher', 'One Flew Over the Cuckoos Nest'),
    ...
    (54,1981,31, 'Sissy Spacek', 'Coal Miners Daughter'),
    (55,1982,74, 'Katharine Hepburn', 'On Golden Pond'),
    (56,1983,33, 'Meryl Streep', 'Sophies Choice'),
    ...
    (73,2000,25, 'Hilary Swank', 'Boys Dont Cry'),
    (74,2001,33, 'Julia Roberts', 'Erin Brockovich'),
    (75,2002,35, 'Halle Berry', 'Monsters Ball'),
    ...
    (90,1928,44, 'Emil Jannings', 'The Last Command'),
    ...
    (101,1939,38, 'Spencer Tracy', 'Boys Town');
